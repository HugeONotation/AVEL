...
namespace avel {
    ...
    template<>
    [[nodiscard]]
    AVEL_FINL std::int16_t broadcast_bit<std::int16_t>(bool x) {
        return -std::int16_t(x);
    }

    [[nodiscard]]
    AVEL_FINL std::int16_t set_bits(std::int16_t m, std::int16_t x) {
        return m | x;
    }

    [[nodiscard]]
    AVEL_FINL std::int16_t keep_bits(std::int16_t m, std::int16_t x) {
        return m & x;
    }

    [[nodiscard]]
    AVEL_FINL std::int16_t clear_bits(std::int16_t m, std::int16_t x) {
        return ~m & x;
    }

    [[nodiscard]]
    AVEL_FINL std::int16_t flip_bits(std::int16_t m, std::int16_t x) {
        return m ^ x;
    }

    [[nodiscard]]
    AVEL_FINL std::int16_t blend_bits(std::int16_t m, std::int16_t a, std::int16_t b) {
        return (m & a) | (~m & b);
    }
    ...
    [[nodiscard]]
    AVEL_FINL bool no_bits(std::int16_t x) {
        return no_bits(static_cast<std::uint16_t>(x));
    }

    [[nodiscard]]
    AVEL_FINL bool no_bits_of(std::int16_t x, std::int16_t m) {
        return no_bits_of(
    ...
    [[nodiscard]]
    AVEL_FINL bool any_bits(std::int16_t x) {
        return any_bits(static_cast<std::uint16_t>(x));
    }

    [[nodiscard]]
    AVEL_FINL bool any_bits_of(std::int16_t x, std::int16_t m) {
        return any_bits_of(
            static_cast<std::uint16_t>(x),
            static_cast<std::uint16_t>(m)
        );
    ...
    [[nodiscard]]
    AVEL_FINL bool all_bits(std::int16_t x) {
        return all_bits(static_cast<std::uint16_t>(x));
    }

    [[nodiscard]]
    AVEL_FINL bool all_bits_of(std::int16_t x, std::int16_t m) {
        return all_bits_of(
            static_cast<std::uint16_t>(x),
            static_cast<std::uint16_t>(m)
        );
