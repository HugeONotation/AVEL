...
namespace avel {
    ...
    vec32x16u broadcast_bit(mask32x16u m);
    ...
    [[nodiscard]]
    AVEL_FINL mask32x16u keep(mask32x16u m, mask32x16u v) {
        return mask32x16u{static_cast<mask32x16u::primitive>(decay(m) & decay(v))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u clear(mask32x16u m, mask32x16u v) {
        return mask32x16u{static_cast<mask32x16u::primitive>(~decay(m) & decay(v))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u blend(mask32x16u m, mask32x16u a, mask32x16u b) {
        return mask32x16u{static_cast<mask32x16u::primitive>((decay(m) & decay(a)) | (~decay(m) & decay(b)))};
    }
    ...
    [[nodiscard]]
    AVEL_FINL vec32x16u broadcast_bit(mask32x16u m) {
    ...
    AVEL_FINL vec32x16u midpoint(vec32x16u a, vec32x16u b) {
        ...
        auto t5 = _mm512_and_si512(_mm512_ternarylogic_epi32(decay(a), decay(b), decay(broadcast_bit(b < a)), 0x14), _mm512_set1_epi16(0x1));
    ...
    [[nodiscard]]
    AVEL_FINL mask32x16u no_bits(vec32x16u v) {
        return mask32x16u{_mm512_testn_epi16_mask(decay(v), decay(v))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u no_bits_of(vec32x16u v, vec32x16u m) {
        return mask32x16u{_mm512_testn_epi16_mask(decay(v), decay(m))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u any_bits(vec32x16u v) {
        return mask32x16u{_mm512_test_epi16_mask(decay(v), decay(v))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u any_bits_of(vec32x16u v, vec32x16u m) {
        return mask32x16u{_mm512_test_epi16_mask(decay(v), decay(m))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u all_bits(vec32x16u v) {
        return mask32x16u{_mm512_cmpeq_epi16_mask(decay(v), _mm512_set1_epi16(-1))};
    }

    [[nodiscard]]
    AVEL_FINL mask32x16u all_bits_of(vec32x16u v, vec32x16u m) {
        return mask32x16u{_mm512_cmpeq_epi16_mask(_mm512_and_si512(decay(v), decay(m)), decay(m))};
    }
