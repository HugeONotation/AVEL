...
namespace avel {
    ...
    vec32x8u broadcast_bit(mask32x8u m);
    ...
    [[nodiscard]]
    AVEL_FINL mask32x8u keep(mask32x8u m, mask32x8u v) {
        #if (defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)) || defined(AVEL_AVX10_1)
        return mask32x8u{static_cast<mask32x8u::primitive>(decay(m) & decay(v))};

        #elif defined(AVEL_AVX2)
        return mask32x8u{_mm256_and_si256(decay(m), decay(v))};
        #endif
    }

    [[nodiscard]]
    AVEL_FINL mask32x8u clear(mask32x8u m, mask32x8u v) {
        #if (defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)) || defined(AVEL_AVX10_1)
        return mask32x8u{static_cast<mask32x8u::primitive>(~decay(m) & decay(v))};

        #elif defined(AVEL_AVX2)
        return mask32x8u{_mm256_andnot_si256(decay(m), decay(v))};
        #endif
    }

    [[nodiscard]]
    AVEL_FINL mask32x8u blend(mask32x8u m, mask32x8u a, mask32x8u b) {
        #if (defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)) || defined(AVEL_AVX10_1)
        return mask32x8u{static_cast<mask32x8u::primitive>((decay(m) & decay(a)) | (~decay(m) & decay(b)))};

        #elif defined(AVEL_AVX2)
        return mask32x8u{_mm256_blendv_epi8(decay(b), decay(a), decay(m))};
    ...
    [[nodiscard]]
    AVEL_FINL vec32x8u broadcast_bit(mask32x8u m) {
        #if (defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)) || defined(AVEL_AVX10_1)
    ...
    AVEL_FINL vec32x8u keep(mask32x8u m, vec32x8u v) {
        ...
        #elif defined(AVEL_AVX2)
        return vec32x8u{_mm256_and_si256(decay(m), decay(v))};
        #endif
    }
    ...
    AVEL_FINL vec32x8u midpoint(vec32x8u a, vec32x8u b) {
        ...
        auto t5 = _mm256_and_si256(_mm256_ternarylogic_epi32(decay(a), decay(b), decay(broadcast_bit(b < a)), 0x14), _mm256_set1_epi8(0x1));
        auto t6 = _mm256_sub_epi8(t1, t5);
        return vec32x8u{t6};

        #elif defined(AVEL_AVX2)
        auto t1 = _mm256_avg_epu8(decay(a), decay(b));
        auto t3 = _mm256_andnot_si256(decay(broadcast_bit(b <= a)), _mm256_xor_si256(decay(a), decay(b)));
    ...
    [[nodiscard]]
    AVEL_FINL mask32x8u no_bits(vec32x8u v) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_testn_epi8_mask(decay(v), decay(v))};

        #elif defined(AVEL_AVX2)
        return mask32x8u{_mm256_cmpeq_epi8(decay(v), _mm256_setzero_si256())};

        #endif
    }

    [[nodiscard]]
    AVEL_FINL mask32x8u no_bits_of(vec32x8u v, vec32x8u m) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_testn_epi8_mask(decay(v), decay(m))};

        #elif defined(AVEL_AVX2)
        return mask32x8u{_mm256_cmpeq_epi8(_mm256_and_si256(decay(v), decay(m)), _mm256_setzero_si256())};

        #endif
    }

    [[nodiscard]]
    AVEL_FINL mask32x8u any_bits(vec32x8u v) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_test_epi8_mask(decay(v), decay(v))};
    ...
    [[nodiscard]]
    AVEL_FINL mask32x8u any_bits_of(vec32x8u v, vec32x8u m) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_test_epi8_mask(decay(v), decay(m))};
    ...
    [[nodiscard]]
    AVEL_FINL mask32x8u all_bits(vec32x8u v) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_cmpeq_epi8_mask(decay(v), _mm256_set1_epi8(-1))};

        #else
        return mask32x8u{_mm256_cmpeq_epi8(decay(v), _mm256_set1_epi8(-1))};

        #endif
    }

    [[nodiscard]]
    AVEL_FINL mask32x8u all_bits_of(vec32x8u v, vec32x8u m) {
        #if defined(AVEL_AVX512VL) && defined(AVEL_AVX512BW)
        return mask32x8u{_mm256_cmpeq_epi8_mask(_mm256_and_si256(decay(v), decay(m)), decay(m))};

        #else
        return mask32x8u{_mm256_cmpeq_epi8(_mm256_and_si256(decay(v), decay(m)), decay(m))};
